...
![alt text](../images/diagram-package.png)
...
![alt text](../images/diagram_class.png)
...
![alt text](../images/diagram_seq1.png)
...
![alt text](../images/diagram_seq2.png)
...
![alt text](../images/diagram_endpoint.png)
...
- Manually tested against the Stripe test environment if the feature touches the payment flow test.
